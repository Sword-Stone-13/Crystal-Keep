...
/datum/controller/subsystem/ticker/proc/checkreqroles()
	...
	//var/list/required_jobs = list("King", "Queen","Merchant") //JTGSZ - 4/11/2024 - This was the prev set of required jobs to go with the hardcoded checks commented out below
