...
/datum/status_effect/debuff/goblingas
	...
	effectedstats = list("skill" = -3, "endurance" = -3)
	duration = 40 SECONDS
...
/datum/status_effect/debuff/cumbrained
	...
	effectedstats = list("mageability" = -10, "strength" = -6, "speed" = -6)
	duration = 60 SECONDS
...
/datum/status_effect/debuff/death_weaken
	...
	effectedstats = list("strength" = -2, "skill" = -2, "mageability" = -2, "constitution" = -2, "endurance" = -2, "speed" = -2)
	var/extralives = 1
