/datum/migrant_wave/slaver
	...
	greet_text = "A group of slavers coming to the Crystal Keep from the western deserts of Zybantine in the hopes of gathering wealth through the trade unfortunate laborers."
