...
//spell categories so that we can differentiate them and have them scale differently, STAMAG pure for frost, STAMAG/STAFAITH for fire, etc
#define STYPE_FIRE					"FIRE"
#define STYPE_LIGHTNING				"LIGHTNING"
#define STYPE_FROST					"FROST"
#define STYPE_CRYSTAL				"CRYSTAL"
