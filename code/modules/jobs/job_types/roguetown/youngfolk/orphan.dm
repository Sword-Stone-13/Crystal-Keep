/datum/job/roguetown/orphan
	...
	tutorial = "Dozens of people end up down on their luck in Enigma every day. They sometimes make something of themselves but much more often die in the streets."
