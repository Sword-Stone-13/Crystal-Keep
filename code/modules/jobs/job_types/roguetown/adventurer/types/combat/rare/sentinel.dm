...
/datum/advclass/sentinel
	name = "Sentinel"
	tutorial = "Elvish Sentinels are reconnaissance scouts sent out by elvish kingdoms to perview areas of interest and display elvish prowess foreignly; their arrows are said to contain poisons from the native trees."
