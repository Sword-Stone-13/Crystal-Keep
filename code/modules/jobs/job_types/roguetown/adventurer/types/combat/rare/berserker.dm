...
/datum/advclass/berserker
	...
	traits_applied = list(TRAIT_CRITICAL_RESISTANCE, TRAIT_NOPAINSTUN, TRAIT_NASTY_EATER, TRAIT_MEDIUMARMOR, TRAIT_BIGGUY) //experimental, but this should be a monster
