/datum/advclass/frostmage
	name = "Frost Mage"
	tutorial = "Frost mages, students of the snowflake, enjoyers of the cold."
	...
	outfit = /datum/outfit/job/roguetown/adventurer/frostmage
	category_tags = list(CTAG_ADVENTURER)
	pickprob = 25
	maximum_possible_slots = 1

/datum/outfit/job/roguetown/adventurer/frostmage


/datum/outfit/job/roguetown/adventurer/frostmage/pre_equip(mob/living/carbon/human/H)
	..()
	...
	beltr = /obj/item/gun/magic/spellbook/frostbite
	...
	if(prob(50))
		beltl = /obj/item/ammo_casing/magic/rayoffrost
	else if(prob(50))
		beltl = /obj/item/gun/magic/spellbook/freezetome
	if(H.mind)
