...
/datum/advclass/dwarfwarrior
	name = "Cavern Warrior"
	tutorial = "Dwarf Warriors are the bread and butter of their miliary sworn to defend their mountain fortress at odds with their Kobold enemies. Armed with either a battle axe or mace, they are a force to be reckoned with."
