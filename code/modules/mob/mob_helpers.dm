...
/// Weights for hitting sub locations in Accuracy Check
...
///Weighted random zone selection for simple mob attacks
...
///This finds the direction one user is to another, relative to the target
...
///This is used to determine which zones are grouped for directional hits
