...
/obj/effect/proc_holder/spell/self/findfamiliar/cast(mob/user = usr)
	...
	var/familiars = list(
		...
		/*/mob/living/simple_animal/hostile/retaliate/rogue/mossback,*/ //psuedodragon will steal later from hearthstone or remove
