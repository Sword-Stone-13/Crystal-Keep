...
/obj/item/chilltouch5e
	...
	var/oxy_drain = 2
	var/pleasure = 0 //pleasurable quicker since they bleed inevitably due embed
	var/curprocs = 0
	var/procsmax = 180
...
/datum/status_effect/buff/infestation5e/tick()
	...
	if(prompt == 1)
		...
		owner.playsound_local(get_turf(owner), 'icons/roguetown/mob/rotten.dmi', 35, FALSE, pressure_affected = FALSE)
