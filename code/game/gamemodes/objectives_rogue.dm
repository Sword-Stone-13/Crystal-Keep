...
/datum/objective/werewolf
	name = "conquer"
	explanation_text = "Put an end to the vampire scourge in Crystal Keep."
	team_explanation_text = "The feud between werewolves and vampires reaches back to the dawn of time."
	triumph_count = 5
...
/datum/objective/vampire
	name = "conquer"
	explanation_text = "Put an end to the werewolf menace in Crystal Keep."
	team_explanation_text = "The feud between werewolves and vampires reaches back to the dawn of time."
	triumph_count = 5
