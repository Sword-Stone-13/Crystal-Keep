...
/turf/closed/mineral/random/rogue/high
	...
	mineralChance = 33
	mineralSpawnChanceList = list(/turf/closed/mineral/rogue/cinnabar = 25,/turf/closed/mineral/rogue/salt = 5,/turf/closed/mineral/rogue/gold = 9,/turf/closed/mineral/rogue/silver = 5,/turf/closed/mineral/rogue/iron = 33,/turf/closed/mineral/rogue/copper = 22,/turf/closed/mineral/rogue/tin = 15,/turf/closed/mineral/rogue/coal = 19, /turf/closed/mineral/rogue/gem = 3)
